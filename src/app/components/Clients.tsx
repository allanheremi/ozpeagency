...
const Clients = () => {
  return (
    <>
      <div className="bg-white text-black p-8 h-[88vh] flex grid-cols-2 flex-col justify-around">
        <h1 className="flex justify-center text-2xl md:py-8">CLIENTS & PARTNERS</h1>
