...
const AboutSection = () => {
  ...
  return (
    <>
      {!isMobile && (
        <>
          <section className="flex h-screen flex-col items-center justify-around gap-y-24 sm:gap-y-4 px-8 py-24">
        ...
        <>
          <section className="h-screen">
            <div className="max-w-screen flex h-[80vh] flex-col justify-center  gap-y-32 text-center md:items-center">
              <h1 className="p-24 text-6xl lg:text-7xl">WHAT WE DO</h1>
